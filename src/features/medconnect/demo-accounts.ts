...
export const DEMO_ACCOUNTS: DemoAccount[] = [
  ...
  { label: "Physiotherapist", email: "physio1@demo.med", password: PW, name: "Kavita Deshmukh (PT)", role: "provider", view: "physio_staff", group: "Nurses, physios & technicians" },
  { label: "Nurse", email: "nurse1@demo.med", password: PW, name: "Sister Asha Pawar", role: "provider", view: "nurse", group: "Nurses, physios & technicians" },
