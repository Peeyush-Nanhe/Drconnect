...
//#region src/lib/ask-ai.functions.ts?tss-serverfn-split
var TRIAGE_PROMPT = [
...
var askTriage_createServerFn_handler = createServerRpc({
	id: "7a412c85eeb878cd4363ca8973936d500799fdab793b69a91604398f445c4cdf",
	name: "askTriage",
	filename: "src/lib/ask-ai.functions.ts"
}, (opts) => askTriage.__executeServer(opts));
var askTriage = createServerFn({ method: "POST" }).inputValidator((d) => {
...
}).handler(askTriage_createServerFn_handler, async ({ data }) => {
...
//#endregion
export { askTriage_createServerFn_handler };
